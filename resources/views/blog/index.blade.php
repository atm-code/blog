...
@section('content')
    ...
    <div class="grid sm:grid-cols-3 gap-1 sm:gap-4">
        ...
        <div class="col-span-1">
            <div class="bord border-2 border-gray-500 border-sketchy-lg hover:border-sketchy-md transition duration-700 ease-in-out p-4 mb-10 shadow-lg bg-white pt-8">
                    ...
                    @foreach($instagram as $feed)
                        <div>
                            <a target="_blank" href="{{ $feed->link ?? '' }}" title="{{ $ffed->caption ?? '' }}">
                                <img alt="{{ $ffed->caption ?? '' }}" class="border-2 border-gray-500 border-sketchy-lg hover:border-sketchy-md transition duration-700 ease-in-out rounded-lg shadow-md" src="{{ $feed->thumbnailSrc ?? '' }}">
