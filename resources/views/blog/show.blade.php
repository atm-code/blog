...
@section('content')
    <div class="bg-white p-4 border-sketchy-lg hover:border-sketchy-md transition duration-700 ease-in-out shadow">
        ...
        <div class="border-sketchy-md mb-10 relative w-full flex items-end justify-start text-left bg-cover bg-center" style="height: 40rem; background-image:url('{{ $post->image_url }}');">
