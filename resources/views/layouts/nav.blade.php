        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
            ...
            <div class="hidden md:flex-1 md:flex md:items-center md:justify-between md:space-x-12">
                <nav class="flex space-x-10">
                    @foreach($menus as $menu)
                        <a href="{{ url($menu->slug) }}" class="@if(request()->is($menu->slug)) text-gray-900 @else text-gray-500 @endif text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
                            {{ $menu->title ?? '' }}
                        </a>
                    @endforeach
                </nav>
            ...
            <div class="rounded-lg shadow-xs bg-white divide-y-2 divide-gray-50">
                ...
                <div class="py-6 px-5 space-y-6">
                    <div class="grid grid-cols-1 gap-4">
                        @foreach($menus as $menu)
                            <a href="{{ url($menu->slug) }}" class="rounded-md text-base leading-6 font-medium @if(request()->is($menu->slug)) text-gray-900 @else text-gray-500 @endif hover:text-gray-700 transition ease-in-out duration-150">
                                {{ $menu->title }}
                            </a>
                        @endforeach
                    </div>
